...
namespace Lineage.Managers
{
    ...
    public class TimeManager : MonoBehaviour
    {
        ...
        private void AdvanceDay()
        {
            ...
            Log.System("TimeManager", $"Day {currentDay} begins. Time: {GetFormattedTime()}", Log.LogLevel.Info);
        }
        ...
        private void AdvanceSeason()
        {
            ...
            if (currentSeason == 0) // Spring = new year
            {
                ...
                Log.System("TimeManager", $"Year {currentYear} begins!", Log.LogLevel.Info);
            }

            Log.System("TimeManager", $"Season changed to {GetSeasonName(currentSeason)}", Log.LogLevel.Info);
        }
        ...
        public void TogglePause()
        {
            ...
            Log.System("TimeManager", isPaused ? "Game Paused" : "Game Resumed", Log.LogLevel.Info);
        }
        ...
        public void SetGameSpeed(float speed)
        {
            ...
            Log.System("TimeManager", $"Game speed set to {gameSpeed}x", Log.LogLevel.Info);
        }
