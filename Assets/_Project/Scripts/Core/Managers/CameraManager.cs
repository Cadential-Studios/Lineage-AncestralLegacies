    ...
    public class CameraManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (Instance == null)
        {
            ...
            // Only call DontDestroyOnLoad on root objects
            ...
            {
                UnityEngine.Debug.LogWarning($"[CameraManager] Cannot use DontDestroyOnLoad on non-root object {gameObject.name}. Parent: {transform.parent.name}", this);
            }
        }
        else
        {
